...
- Monte Carlo validation (MANDATORY before any live trading)
- H4 timeframe testing (fewer but higher-quality trades?)
- XAUUSD (Gold) data available but untested
- Session filters (London/NY overlap only)
- Walk-forward validation (train 70%, test 30%)
- ATR regime detection (different params for different volatility)
